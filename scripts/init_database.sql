...
Script Purpose:
This script creates a new database named 'DataWarehouse' afrer checkinf if it already exists.
...
IF EXISTS (SELECT 1 FROM sys.databases WHERE name='Datawarehouse')
  BEGIN
    ALTER DATABASE DataWarehouse SET SINGLE_USER WITH ROLLBACK IMMIDATE;
